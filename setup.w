...
<div xmlns="http://www.w3.org/1999/xhtml" xid="window" class="window" component="$UI/system/components/justep/window/window"
  design="device:m;">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:168px;top:68px;"><div component="$UI/system/components/justep/data/data" autoLoad="true" xid="regData" idColumn="name"><column label="名称：" name="name" type="String" xid="xid1"></column>
  <column label="密码：" name="pwd" type="String" xid="xid2"></column>
  <column label="确认密码：" name="repwd" type="String" xid="xid3"></column>
  <column label="邮箱：" name="email" type="String" xid="xid4"></column></div></div>  
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
   ...
   <span xid="span1"></span></a></div>  
    ...
    <div class="x-panel-content" xid="content1">
      <div component="$UI/system/components/justep/controlGroup/controlGroup"
        ...
        <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30"
          ...
          <input component="$UI/system/components/justep/input/input" class="form-control x-edit"
            xid="userName" placeHolder="请输入账号"/>
        </div>  
      ...
      </div><div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30"
          xid="labelEdit2"> 
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-primary center-block" label="注册" xid="regBtn" onClick="regBtnClick">
   <i xid="i1"></i>
